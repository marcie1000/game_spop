...
extern int draw_window(s_emu *emu, int i, uint8_t *pixel);
extern int draw_background(s_emu *emu, int i, uint8_t *pixel);
extern int draw_OBJ(s_emu *emu, int i, uint8_t *pixel);
